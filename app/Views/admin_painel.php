            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        $label = ['tad' => 'TAD', 'lista_simples' => 'Lista Simples', 'lista_dupla' => 'Lista Dupla', 'fila_fifo'=>'Fila FIFO','fila_prioridade'=>'Prioridades','pilha'=>'Pilha'];
                    ...
                    <td>
                        <div class="acoes">
                            ...
                            <form method="post" action="excluir.php"><?=campoCsrf()?><button name="id" value="<?=$item['id']?>" class="btn-excluir btn-confirmar-excluir">Excluir</button></form>
                        </div>
                    </td>
                </tr>
                <?php endforeach; ?>
